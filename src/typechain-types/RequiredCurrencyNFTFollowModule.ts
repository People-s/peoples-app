...
export interface RequiredCurrencyNFTFollowModuleInterface
...
export interface RequiredCurrencyNFTFollowModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RequiredCurrencyNFTFollowModuleInterface;
